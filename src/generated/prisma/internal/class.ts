...
/**
   ...
   * `prisma.savedAnalyticsView`: Exposes CRUD operations for the **SavedAnalyticsView** model.
    ...
    * ```
    */
  get savedAnalyticsView(): Prisma.SavedAnalyticsViewDelegate<ExtArgs, { omit: OmitOpts }>;
  ...
  /**
   * `prisma.premiumEvent`: Exposes CRUD operations for the **PremiumEvent** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more PremiumEvents
    * const premiumEvents = await prisma.premiumEvent.findMany()
    * ```
    */
  get premiumEvent(): Prisma.PremiumEventDelegate<ExtArgs, { omit: OmitOpts }>;
}
