	...
	private buildTransactionParseInstructions(
		...
		const categoryInstruction =
			categoryList.length > 0
				? ` Для каждой транзакции выбери одну категорию по описанию/названию из списка: ${categoryList}. Категория обязательна: если не можешь определить, укажи "📦Другое". Для еды и продуктов (продукты, мороженое, кофе, хлеб, молоко, пицца, суши и т.п.) выбирай "🍔Еда и напитки".`
